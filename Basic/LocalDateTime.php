...
class LocalDateTime extends DateTime {
    ...
    const DATE_GERMAN = 'd.m.Y'; // TODO: Verwenden

    const DATETIME_MYSQL = 'Y-m-d H:i:s';
    const DATETIME_GERMAN = 'd.m.Y H:i:s'; // TODO: Verwenden
     ...
     * @var array
     */
    public static $WEEKDAY = array('Sonntag', 'Montag', 'Dienstag', 'Mittwoch', 'Donnerstag', 'Freitag', 'Samstag');
     ...
     * @var array
     */
    public static $MONTH = array('Januar', 'Februar', 'März', 'April', 'Mai', 'Juni', 'Juli', 'August', 'September', 'Oktober', 'November', 'Dezember');
     ...
     * @var array
     */
    private static $feastDays = array();
     ...
     */
    public function __construct($date = 'now', $format_string = null, $modify_string = '') {
	 ...
	 * @return string
	 */
    public function toGermanDateTimeFormat(): string { // TODO: Umbenennen zu getGermanDateTime
     ...
     *
     * Mögliche Werte für $feastday_mapping_key: @see LocalDateTime::FEASTDAY_MAPPING (die Keys)
     *
     * @param int $year Gewünschtes Jahr im Format 'JJJJ'
     ...
     */
    public static function feastDays($year, $feastday_mapping_key) {
        ...
        if(substr($feastday_mapping_key, 0, 2) == 'BY') {
     ...
     * @return false|string
     */
    public function isFeastDay($feastday_mapping_key) {
     ...
     *
     * Mögliche Werte: @see LocalDateTime::FEASTDAY_MAPPING (die Keys)
     *
     ...
     */
    public static function feastOrWeekendDay($datum, $feastday_mapping_key) {
     ...
     * @return int
     */
    public static function feastOrWeekendDayAmount($start_dt, $end_dt, $feastday_mapping_key) {
        $amount = 0;
     ...
     * @return string
     */
    public static function fixYear($year) {
     ...
     * @return LocalDateTime
     */
    public static function getWeekdayInSameWeek($weekday_number, DateTime $dt) {
     ...
     * @return DateTime
     */
    public static function roundToMinuteInterval(DateTime $dt, $minute_interval = 5, $round_up = true) {
     ...
     * @return int
     */
    public static function totalMinutes($date_interval) {
     ...
     * @return string
     */
    public static function minutesToHourString($minutes) {
